...
package samples.async.simple;

import org.apache.dubbo.rpc.RpcContext;
import org.springframework.context.support.ClassPathXmlApplicationContext;
import samples.async.simple.api.AsyncService;
...
public class AsyncConsumer {
    ...
    public static void main(String[] args) throws Exception {
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("samples.simple/async-consumer.xml");
        context.start();
