 ...
 */
package samples.annotation.impl;

import org.apache.dubbo.config.annotation.DubboService;
import samples.annotation.AnnotationConstants;
import samples.annotation.api.GreetingService;

@DubboService(version = samples.annotation.AnnotationConstants.VERSION)
public class AnnotationGreetingServiceImpl implements GreetingService {
    public AnnotationGreetingServiceImpl() {
        System.out.println("init AnnotationGreetingServiceImpl");
    }
