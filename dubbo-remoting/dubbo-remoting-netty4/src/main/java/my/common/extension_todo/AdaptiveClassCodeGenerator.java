...
public class AdaptiveClassCodeGenerator {
    ...
    private boolean hasAdaptiveMethod() {
        return Arrays.stream(type.getMethods()).anyMatch(m -> m.isAnnotationPresent(org.apache.dubbo.common.extension.Adaptive.class));
    }
...
//        }
    ...
    private String generateImports() {
        return String.format(CODE_IMPORTS, org.apache.dubbo.common.extension.ExtensionLoader.class.getName());
    }
