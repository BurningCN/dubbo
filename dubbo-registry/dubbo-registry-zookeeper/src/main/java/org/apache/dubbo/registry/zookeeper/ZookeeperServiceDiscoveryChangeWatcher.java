 ...
 * which will multicast（组播/多播） a {@link ServiceInstancesChangedEvent} when the service node has been changed.
 *
 * @since 2.7.5
 */
// 这个结构和CuratorWatcherImpl很像的，只是仅实现了CuratorWatcher接口，实现process方法
